...
export default function Index() {
  // Data ----------------------------------------------------------------
  const [detailOrderPreparing, setDetailOrderPreparing] = useState({
    quantity: 2,
    money: "580.000đ",
    listProduct: [
      {
  ...
  // Nút xuất đơn hàng ---------------------------------------------------
  function OrderOut() {
    alert("Chuyển trạng thái đơn hàng sang đang giao hàng");
  }
            ...
            <div className="box">
              ...
              <div class="table">
                <table>
                  ...
                  {detailOrderPreparing.listProduct.map((e) => (
                    <tr>
                  ...
                  <tr>
                    ...
                    <td className="amount__browseOrder text__weight__browseOrder">
                      Số lượng:{" " + detailOrderPreparing.quantity}
                    </td>
                    <td className="sumPrice__browseOrder text__weight__browseOrder">
                      Tổng tiền:{" " + detailOrderPreparing.money}
                    </td>
                  </tr>
                </table>
                <hr />
              ...
              <div className="group__btn__detailOrderWarehouse">
                <button className="button" onClick={() => OrderOut()}>
                  Xuất đơn hàng
                </button>
              </div>
            </div>
