...
export default function Index() {
  // Data ----------------------------------------------------------------
  const [detailOrderApproved, setDetailOrderApproved] = useState({
    quantity: 2,
    money: "580.000đ",
    listProduct: [
      {
  ...
  // XUẤT THÔNG TIN ĐƠN HÀNG ĐÃ DUYỆT ------------------------------------------
  function ExportOrder() {
    alert("Xuất bill đơn hàng đã duyệt để chuẩn bị hàng và chuyển trạng thái đơn hàng thành đang chuẩn bị");
  }
  return (
    <div>
        ...
        <div className="content">
          ...
          <div className="wrapper__content">
            <div className="title__content row">
              ...
              <p>Chi tiết đơn hàng đã duyệt</p>
            </div>
            <div className="box">
              <p>
              ...
              <div class="table">
                <table>
                  ...
                  {detailOrderApproved.listProduct.map((e) => (
                    <tr>
                  ...
                  <tr>
                    ...
                    <td className="amount__browseOrder text__weight__browseOrder">
                      Số lượng:{" " + detailOrderApproved.quantity}
                    </td>
                    <td className="sumPrice__browseOrder text__weight__browseOrder">
                      Tổng tiền:{" " + detailOrderApproved.money}
                    </td>
                  </tr>
                </table>
                <hr />
                ...
                <div className="group__btn__detailOrderWarehouse">
                  <button className="button" onClick={() => ExportOrder()}>
