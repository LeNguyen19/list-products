...
export default function Index() {
  ...
  // LỌC SẢN PHẨM TIÊU HUỶ
  function FilterProductlistProductDestruction() {
    console.log(
      "Loại sản phẩm: ",
  ...
  // DANH SÁCH SẢN PHẨM TIÊU HUỶ
  const [listProductDestruction, setListProductlistProductDestruction] =
    useState([
      {
        id: 1,
        ...
        <div className="content">
          ...
          <div className="wrapper__content">
            ...
            <div className="box row-jcsb">
              ...
              <button
                className="button"
                onClick={() => FilterProductlistProductDestruction()}
              >
                Lọc
              </button>
            </div>
