      ...
      <div className="content">
        ...
        <div className="wrapper__content">
          <div className="title__content row">
            ...
            <p>Kiểm duyệt nhập hàng nhà cung cấp</p>
          </div>
          <div className="box">
            <p>
            ...
            <div class="table">
              <table>
                ...
                <tr>
                  <td className="code__browseGoods">PNH01</td>
                  <td className="status__browseGoods">01/01/2001</td>
                  ...
                  <td className="seen__browseGoods">
                    <Link to="/Admin/BrowseImportGoods/DetailImportGoods">
                      <i class="fa fa-eye"></i>
                    </Link>
                  </td>
                </tr>
